...
const en = {
  ...
  'quiz.doneSubtitle': 'Nice work — you reviewed every card in the set.',
...
const sr: Record<TranslationKey, string> = {
  ...
  'quiz.setupSubtitle': 'Napravite set kartica iz gradiva vašeg predmeta.',
  'quiz.generate': 'Napravi kviz',
  'quiz.topic': 'Tema (opciono)',
  'quiz.topicPlaceholder': 'npr. projektni obrasci',
  ...
  'quiz.doneSubtitle': 'Odlično — pregledali ste sve kartice u setu.',
